            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <dl class="row">
                        ...
                        <dt class="form-label">Ombro</dt>
                        <dd class="form-control"><span id="ombroUsuario"></span></dd>
                        ...
                        <dt class="form-label">Editado por</dt>
                        <dd class="form-control"><span id="edicaoUsuario"></span></dd>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit-ficha-form">
                        ...
                        <div class="mb-3">
                            <label for="ombro" class="col-form-label">Ombro:</label>
                            <input type="text" name="ombro" class="form-control" id="editombro">
                        </div>
...
<div class="footer">
    ...
    <script src="js/custom-ficha.js"></script>
